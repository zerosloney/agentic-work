# codebuddy / sub-agents

> Source: https://www.codebuddy.cn/docs/cli/sub-agents
...
### 子代理专属 MCP server [​](#子代理专属-mcp-server)
...
#### Direct 和 deferred [​](#direct-和-deferred)
...
### 使用 /agents 命令（推荐） [​](#使用-agents-命令-推荐)
...
### 为内置子代理配置模型（per-Agent 模型） [​](#为内置子代理配置模型-per-agent-模型)
...
### General-Purpose 子代理 [​](#general-purpose-子代理)
