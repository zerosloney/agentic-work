...
> Source: https://www.codebuddy.cn/docs/cli/slash-commands
> Fetched: 2026-07-29 20:24:35

---

# CodeBuddy Code 斜杠命令 （Slash Commands) [​](#codebuddy-code-斜杠命令-slash-commands)

CodeBuddy Code 支持斜杠命令，允许您在聊天中执行特殊操作、管理会话以及自定义常用工作流。

## 内置斜杠命令 （Built-in Slash Commands) [​](#内置斜杠命令-built-in-slash-commands)
...
## 自定义斜杠命令 （Custom Slash Commands) [​](#自定义斜杠命令-custom-slash-commands)
...
### Frontmatter 与元数据 [​](#frontmatter-与元数据)
...
#### 方式二：捕获所有参数 （$ARGUMENTS) [​](#方式二-捕获所有参数-arguments)
