# codebuddy / plugin-marketplaces

> Source: https://www.codebuddy.cn/docs/cli/plugin-marketplaces
> Fetched: 2026-07-29 20:24:36

---

# 插件市场（Plugin Marketplaces） [​](#插件市场-plugin-marketplaces)
...
### 1. 在 GitHub 上托管（推荐） [​](#_1-在-github-上托管-推荐)
...
### 2. 在其他 Git 服务上托管 [​](#_2-在其他-git-服务上托管)
...
### 3. 使用 HTTP URL 托管 [​](#_3-使用-http-url-托管)
...
#### 方式 1：通过环境变量全局启用 [​](#方式-1-通过环境变量全局启用)
